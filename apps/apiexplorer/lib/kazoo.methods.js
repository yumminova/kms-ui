{
	...
	"servicePlan": {
		"title": "Service plans",
		"get": { "verb": "GET", "url": "accounts/{accountId}/services/{planId}" },
		"add": { "verb": "POST", "url": "accounts/{accountId}/services/{planId}", "schemas": "schemas/service_plans" },
		"addMany": { "verb": "POST", "url": "accounts/{accountId}/services/" },
		"remove": { "verb": "DELETE", "url": "accounts/{accountId}/service_plans/{planId}" },
		"removeMany": { "verb": "DELETE", "url": "accounts/{accountId}/services/" },
		"update": { "verb": "POST", "url": "accounts/{accountId}/services/", "schemas": "schemas/service_plans" },
		"addManyOverrides": { "verb": "POST", "url": "accounts/{accountId}/service_plans/override" },
		"list": { "verb": "GET", "url": "accounts/{accountId}/services" },
		"listCurrent": { "verb": "GET", "url": "accounts/{accountId}/services/current" },
		"getCsv": { "verb": "GET", "url": "accounts/{accountId}/services/current?depth=4&identifier=items&accept=csv" },
		"listAvailable": { "verb": "GET", "url": "accounts/{accountId}/services/available" },
		"getAvailable": { "verb": "GET", "url": "accounts/{accountId}/services/available/{planId}" },
		"reconciliate": { "verb": "POST", "url": "accounts/{accountId}/services/reconciliation" },
		"synchronize": { "verb": "POST", "url": "accounts/{accountId}/services/synchronization" }
	},
	"temporalRule": {
